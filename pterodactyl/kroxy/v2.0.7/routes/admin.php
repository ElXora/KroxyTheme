...
|
*/
Route::group(['prefix' => 'kroxy'], function () {
    Route::get('/', [Admin\Kroxy\KroxyController::class, 'index'])->name('admin.kroxy');
    Route::post('/', [Admin\Kroxy\KroxyController::class, 'store']);

    Route::get('/layout', [Admin\Kroxy\KroxyLayoutController::class, 'index'])->name('admin.kroxy.layout');
    Route::post('/layout', [Admin\Kroxy\KroxyLayoutController::class, 'store']);

    Route::get('/components', [Admin\Kroxy\KroxyComponentsController::class, 'index'])->name('admin.kroxy.components');
    Route::post('/components', [Admin\Kroxy\KroxyComponentsController::class, 'store']);

    Route::get('/dashboard', [Admin\Kroxy\KroxyDashboardController::class, 'index'])->name('admin.kroxy.dashboard');
    Route::post('/dashboard', [Admin\Kroxy\KroxyDashboardController::class, 'store']);

    Route::get('/announcement', [Admin\Kroxy\KroxyAnnouncementController::class, 'index'])->name('admin.kroxy.announcement');
    Route::post('/announcement', [Admin\Kroxy\KroxyAnnouncementController::class, 'store']);

    Route::get('/mail', [Admin\Kroxy\KroxyMailController::class, 'index'])->name('admin.kroxy.mail');
    Route::post('/mail', [Admin\Kroxy\KroxyMailController::class, 'store']);

    Route::get('/styling', [Admin\Kroxy\KroxyStylingController::class, 'index'])->name('admin.kroxy.styling');
    Route::post('/styling', [Admin\Kroxy\KroxyStylingController::class, 'store']);

    Route::get('/meta', [Admin\Kroxy\KroxyMetaController::class, 'index'])->name('admin.kroxy.meta');
    Route::post('/meta', [Admin\Kroxy\KroxyMetaController::class, 'store']);

    Route::get('/colors', [Admin\Kroxy\KroxyColorsController::class, 'index'])->name('admin.kroxy.colors');
    Route::post('/colors', [Admin\Kroxy\KroxyColorsController::class, 'store']);

    Route::get('/social', [Admin\Kroxy\KroxySocialController::class, 'index'])->name('admin.kroxy.social');
    Route::post('/social', [Admin\Kroxy\KroxySocialController::class, 'store']);

    Route::get('/advanced', [Admin\Kroxy\KroxyAdvancedController::class, 'index'])->name('admin.kroxy.advanced');
    Route::post('/advanced', [Admin\Kroxy\KroxyAdvancedController::class, 'store']);
    
    Route::post('/advanced/preset', [Admin\Kroxy\KroxyAdvancedController::class, 'preset'])->name('admin.kroxy.advanced.preset');
});
