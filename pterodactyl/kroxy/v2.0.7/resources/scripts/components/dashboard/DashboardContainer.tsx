...
export default () => {
    const { t } = useTranslation('kroxy/dashboard');
    ...
    const discordBox = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.discordBox);
    const discord = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.discord);
    const socials = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.socials);
    const socialButtons = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.socialButtons);
    const serverRow = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.serverRow);
                    ...
                    {socials.map((social, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <IconComponent className={'text-[2.5rem] text-kroxy'}/>
                            </a>
                        );
                    })}
                </div>
