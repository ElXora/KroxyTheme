...
export default () => {
    const { t } = useTranslation('kroxy/account');
                    ...
                    <div className={'bg-gray-700 backdrop rounded-box px-6 py-5'}>
                        <div className={'flex justify-between mb-5'}>
                            ...
                            <div className={'flex gap-x-4'}>
                                <button onClick={() => setIsTab('api')} className={`pb-2 border-b duration-300 ${isTab === 'api' ? 'border-kroxy text-gray-50' : 'border-transparent hover:text-gray-50'}`}>
                                    {t('apikey')}
                                </button>
                                <button onClick={() => setIsTab('ssh')} className={`pb-2 border-b duration-300 ${isTab === 'ssh' ? 'border-kroxy text-gray-50' : 'border-transparent hover:text-gray-50'}`}>
                                    {t('sshkey')}
                                </button>
                            </div>
                        </div>
