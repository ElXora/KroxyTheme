...
const Announcement = () => {
    ...
    const announcement = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcement);
    const announcementColor = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementColor);
    const announcementIcon = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementIcon);
    const announcementMessage = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementMessage);
    const announcementCta = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementCta);
    const announcementCtaTitle = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementCtaTitle);
    const announcementCtaLink = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementCtaLink);
    const announcementDismissable = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.announcementDismissable);
