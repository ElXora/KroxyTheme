...
export default ({ children }: Props) => {
    ...
    const { t } = useTranslation(['kroxy/navigation']);

    const name = useStoreState((state: ApplicationStore) => state.settings.data!.name);
    const layout = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.layout);
    ...
    const searchComponent = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.searchComponent);
    ...
    const icon = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.icon);
