...
const InformationBar = () => {
    ...
    const { t } = useTranslation(['kroxy/utilities', 'kroxy/navigation']);
            ...
            <NavigationLinks>
                ...
                {rootAdmin && (
                    ...
                    <a href={`/admin/servers/view/${serverId}`} target={'_blank'}>
                        <FontAwesomeIcon icon={faExternalLinkAlt} /> {t('admin-view', { ns: 'kroxy/navigation' })}
                    </a>
                )}
            </NavigationLinks>}
        </div>
