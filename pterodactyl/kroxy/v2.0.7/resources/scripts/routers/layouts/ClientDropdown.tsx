...
const ClientDropdown = ({ sideBar }: Dropdown) => {
    ...
    const modeToggler = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.modeToggler);
    ...
    return(
        <div className="flex w-full justify-between items-center">
            ...
            >
                ...
                {rootAdmin && (
                    <>
                    <DropdownLinkRow href="/admin/kroxy" className="bg-kroxy !text-black">
                        <ColorSwatchIcon className="w-5 !text-white" /> Kroxy Editor
                    </DropdownLinkRow>
