...
/*
        ...
        Kroxy Theme has already handled many panel 
...
export default () => {
    ...
    const background = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.background);
    const backgroundFaded = useStoreState((state: ApplicationStore) => state.settings.data!.kroxy.backgroundFaded);
