    ...
    <head>
        ...
        <style>
            ...
            .kroxy::after {
                ...
                animation: kroxyAnimationNav 10s infinite linear;
                transition: 0.3s;
            }
            .kroxy:hover::after{
                opacity: 0.7;
            }
            .kroxy span, .kroxy svg {
                font-weight: 500;
                color: #ffffff;
            }
            @keyframes kroxyAnimationNav {
                0%, 100% {
            ...
            :root {
                ...
                --text: {{ $siteConfiguration['kroxy']['gray200'] }};
                --text-secondary: {{ $siteConfiguration['kroxy']['gray300'] }};

                --box: {{ $siteConfiguration['kroxy']['gray700'] }};
                --box-header: {{ $siteConfiguration['kroxy']['gray700'] }};
                
                --active-border: {{ $siteConfiguration['kroxy']['gray500'] }};
                --active: {{ $siteConfiguration['kroxy']['gray600'] }};

                --input: {{ $siteConfiguration['kroxy']['gray600'] }};
                --input-border: {{ $siteConfiguration['kroxy']['gray500'] }};

                --sidebar: {{ $siteConfiguration['kroxy']['gray700'] }};

                --background: {{ $siteConfiguration['kroxy']['gray800'] }};
            }
        </style>
    </head>
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="kroxy">
                            <a href="{{ route('admin.kroxy')}}">
                                <i data-lucide="wand-2"></i><span>Kroxy Theme</span>
                            </a>
                        </li>
