...
<html>
    <head>
        ...
        @section('scripts')
            ...
            {!! Theme::css('css/kroxy.css?t={cache-version}') !!}
        ...
        <nav>
            <div>
                <a href="{{ route('index') }}" class="logo">
                    <img src="/kroxy/Kroxy.png" class="logo" alt="Kroxy Logo"/>
                    Kroxy Editor v{{ config('app.kroxy') }}
                </a>
            </div>
            <div class="nav-end">
        ...
        <div class="wrapper">
            ...
            @if($sideEditor)
                <div class="sideEditor-container">
                    ...
                    @else
                        <div class="iframe-container">
                            <iframe src="/" width="100%" title="Kroxy Live Preview" id="iframe"></iframe> 
                        </div>
                    @endif
                </div>
            @else
