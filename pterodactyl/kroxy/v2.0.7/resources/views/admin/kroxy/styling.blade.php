@extends('layouts.kroxy', ['navbar' => 'styling', 'sideEditor' => false])
...
@php
    $pageTitles = [
        ['img' => '/kroxy/styling/pagetitleson.png', 'value' => 'true', 'label' => 'Enable'],
        ['img' => '/kroxy/styling/pagetitlesoff.png', 'value' => 'false', 'label' => 'Disable'],
    ];
    $backgroundFadedOptions = [
        ['img' => '/kroxy/styling/backgroundDefault.png', 'value' => 'default', 'label' => 'Non faded'],
        ['img' => '/kroxy/styling/backgroundFaded.png', 'value' => 'faded', 'label' => 'Faded'],
        ['img' => '/kroxy/styling/backgroundTranslucent.png', 'value' => 'translucent', 'label' => 'Translucent'],
    ];
    $backdropOptions = [
        ['img' => '/kroxy/styling/blurFalse.png', 'value' => 'false', 'label' => 'No blur'],
        ['img' => '/kroxy/styling/blurTrue.png', 'value' => 'true', 'label' => 'Blur'],
    ];
    $borderInputOptions = [
        ['img' => '/kroxy/styling/borderFalse.png', 'value' => 'false', 'label' => 'Without border'],
        ['img' => '/kroxy/styling/borderTrue.png', 'value' => 'true', 'label' => 'With border'],
    ];
    $flashMessageOptions = [
        ['img' => '/kroxy/styling/flashStyleOne.png', 'value' => 0, 'label' => 'Basic'],
        ['img' => '/kroxy/styling/flashStyleZero.png', 'value' => 1, 'label' => 'Fancy'],
    ];
    $iconOptions = [
        ['img' => '/kroxy/styling/Heroicons Outlined.png', 'value' => 'heroicons', 'label' => 'Heroicons (Outlined)'],
        ['img' => '/kroxy/styling/Heroicons Filled.png', 'value' => 'heroiconsFilled', 'label' => 'Heroicons (Solid)'],
        ['img' => '/kroxy/styling/Lucide.png', 'value' => 'lucide', 'label' => 'Lucide'],
        ['img' => '/kroxy/styling/Remixicons Outlined.png', 'value' => 'remixicon', 'label' => 'Remixicon (Outlined)'],
        ['img' => '/kroxy/styling/Remixicons Filled.png', 'value' => 'remixiconFilled', 'label' => 'Remixicon (Solid)'],
    ];
@endphp

@section('content')
    <form action="{{ route('admin.kroxy.styling') }}" method="POST" class="content-box">
        <div class="header">
            <p>Styling settings</p>
            <span class="description-text">Customize the general appears of Kroxy Theme.</span>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        const switchElement = document.querySelector('#kroxy\\:background');
