@extends('layouts.kroxy', ['navbar' => 'colors', 'sideEditor' => true, 'extraWide' => true])
...
@section('content')
    <form action="{{ route('admin.kroxy.colors') }}" method="POST">
        <div class="header">
            <p>Color settings</p>
            <span class="description-text">Utilize the Kroxy theme color picker to apply your color scheme effortlessly!</span>
        </div>
        <div>
        ...
        <div class="color-options">
            ...
            <x-kroxy.color-input
                target="dangerBorder"
                id="kroxy:dangerBorder" 
                :value="$dangerBorder"
                helpText="Element border"
            />
            <x-kroxy.color-input
                target="dangerBackground"
                id="kroxy:dangerBackground" 
        ...
        <div class="color-options">
            <x-kroxy.color-input
                ...
                id="kroxy:secondaryText" 
                :value="$secondaryText"
                helpText="Element text"
            />
            <x-kroxy.color-input
                target="secondaryBorder"
                id="kroxy:secondaryBorder" 
                :value="$secondaryBorder"
                helpText="Element border"
            />
            <x-kroxy.color-input
                target="secondaryBackground"
                id="kroxy:secondaryBackground" 
